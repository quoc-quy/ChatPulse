...
export const getMessagesController = async (req: Request, res: Response) => {
  ...
  return res.status(httpStatus.OK).json({ message: 'Lấy lịch sử thành công', result: messages })
}
...
export const sendMessageController = async (req: Request, res: Response) => {
  ...
  return res.status(httpStatus.OK).json({ message: 'Gửi tin nhắn thành công', result: message })
}
...
export const editMessageController = async (req: any, res: any) => {
  ...
  return res.json({ message: 'Sửa tin nhắn thành công', result })
}
...
export const deleteMessageController = async (req: Request, res: Response) => {
  ...
  return res.json({ message: 'Xóa tin nhắn phía bạn thành công', result })
}
...
export const reactMessageController = async (req: Request, res: Response) => {
  ...
  return res.json({ message: 'Thả cảm xúc thành công', result })
}
...
export const revokeMessageController = async (req: Request, res: Response) => {
  ...
  return res.json({ message: 'Thu hồi tin nhắn thành công', result })
}
...
export const deleteMessageForMeController = async (req: Request, res: Response) => {
  ...
  return res.status(httpStatus.OK).json({ message: 'Xóa tin nhắn phía tôi thành công', result })
}
...
export const searchMessagesController = async (req: Request, res: Response) => {
  ...
  if (!keyword) {
    return res.status(httpStatus.BAD_REQUEST).json({ message: 'Vui lòng nhập từ khóa', result: null })
  }

  const result = await messageService.searchMessages(convId, user_id, keyword, page, limit)
  return res.status(httpStatus.OK).json({ message: 'Tìm kiếm thành công', result })
}
...
export const forwardMessageController = async (req: Request, res: Response) => {
  ...
  return res.status(httpStatus.OK).json({ message: 'Chuyển tiếp thành công', result })
}
...
export const summarizeMessageController = async (req: Request, res: Response) => {
  const { id } = req.params
  const { user_id } = req.decoded_authorization as TokenPayload

  const result = await messageService.summarizeMessage(id as string, user_id)
  return res.status(httpStatus.OK).json({ message: 'Tóm tắt tin nhắn thành công', result })
}
