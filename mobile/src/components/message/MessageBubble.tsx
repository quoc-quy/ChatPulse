...
export const MessageBubble = React.memo(
  ({
    ...
    const isAiGenerated =
      typeof displayContent === 'string' && displayContent.startsWith('@PulseAI ')
                      ...
                      >
                        ...
                        >
                          ...
                          <View style={{ flex: 1, minWidth: 0, paddingRight: 6 }}>
                            ...
                            >
                              {!!sz && (
                                <Text style={[B.fileMeta, { color: COLORS.textLight }]}>
                                  {sz} •{' '}
                                </Text>
                              )}
                              <Ionicons
                              ...
                              />
                              <Text
                                style={[B.fileMeta, { color: COLORS.textLight, marginLeft: 2 }]}
                              >
                                Đã có trên Cloud
                              </Text>
                            </View>
