...
export const ConversationItem = ({
  ...
  const { chatName, chatAvatarUrl, isOnline, targetUserId, isGroup, membersData } =
    getChatDetails(item)
  ...
  if (item.lastMessage) {
    ...
    } else if (item.lastMessage.type === 'sticker') {
      messageContent = `[${t.sticker || 'Nhãn dán'}]`
    } else if (item.lastMessage.type === 'revoked') {
      messageContent = t.messageRevoked || 'Tin nhắn đã được thu hồi'
    } else {
      ...
      <Swipeable renderRightActions={renderRightActions}>
        ...
        >
          <View style={styles.avatarWrapper}>
            ...
            {isOnline && !isPinned && !isStranger && <View style={styles.onlineDot} />}
          </View>
